...
import DataPassingExample from '../components/dataPassingExample/DataPassingExample.vue'
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/examples/data-passing-example',
        name: 'DataPassingExample',
        component: DataPassingExample
      },
    ],
